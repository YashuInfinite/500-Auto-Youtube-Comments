# 500-Auto-Youtube-Comments
A Python and Selenium browser-automation project that demonstrates automated YouTube comment interactions using a local Chrome debugging session
